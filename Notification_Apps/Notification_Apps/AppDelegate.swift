...
class AppDelegate: UIResponder, UIApplicationDelegate {
    ...
    func application(application: UIApplication, didFinishLaunchingWithOptions launchOptions: [NSObject: AnyObject]?) -> Bool {
        ...
        //NS Set of all categorie s
        
        let categories:NSSet = NSSet(object: firstCategory)
        
        
        //Notifications Settings Dialog Box
    ...
    func application(application: UIApplication, handleActionWithIdentifier identifier: String?, forRemoteNotification userInfo: [NSObject : AnyObject], completionHandler: () -> Void)
    {
        ...
        {
            NSNotificationCenter.defaultCenter().postNotificationName("Action 1 pressed", object: nil)
        }else if(identifier == "SECOND_ACTION")
        {
            NSNotificationCenter.defaultCenter().postNotificationName("Action 2 pressed", object: nil)
        }
        completionHandler()
